...
public abstract class TTransport implements Closeable {
   ...
   *
   * @throws Exception if the transport could not be opened
   */
   ...
   * @throws Exception if there was an error reading data
   */
   ...
   * @throws Exception if an error occurs writing data
   */
   ...
   * @throws Exception if there was an error writing data
   */
   ...
   *
   * @throws Exception if there was an error writing out data.
   */
  public void flush()
    throws Exception {}

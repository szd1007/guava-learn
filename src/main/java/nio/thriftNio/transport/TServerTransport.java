...
public abstract class TServerTransport implements Closeable {
  ...
  public final TTransport accept() throws Exception {
    TTransport transport = acceptImpl();
    if (transport == null) {
      throw new Exception("accept() may not return NULL");
    }
    return transport;
  }
  ...
  protected abstract TTransport acceptImpl() throws Exception;

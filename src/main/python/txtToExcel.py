...
def convet():
    ...
    outTitle = ["单据编号","单据状态","事务类型","出库发起时间","出库完成时间","商品所属商户","库存组织","商品编码","商品名称","出库数量","商品唯一编号（SN）","仓库","库位","供应商","实际成本","商品销售价格","邮费","折扣额","实付金额（不含邮费）","价税合计","客户订单号","确认收货时间","支付方式","支付公司流水号","物流公司","物流单号"]
    delimiter = "\t"
